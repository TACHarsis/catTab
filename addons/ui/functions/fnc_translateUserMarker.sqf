...
private _texture1 = call {
	...
	if (_markerIcon == 7) exitWith {QPATHTOEF(data,img\o_inf_rifle.paa)};
	if (_markerIcon == 8) exitWith {QPATHTOEF(data,img\o_inf_mg.paa)};
	if (_markerIcon == 9) exitWith {QPATHTOEF(data,img\o_inf_at.paa)};
	if (_markerIcon == 10) exitWith {QPATHTOEF(data,img\o_inf_mmg.paa)};
	if (_markerIcon == 11) exitWith {QPATHTOEF(data,img\o_inf_mat.paa)};
	if (_markerIcon == 12) exitWith {QPATHTOEF(data,img\o_inf_mmortar.paa)};
	if (_markerIcon == 13) exitWith {QPATHTOEF(data,img\o_inf_aa.paa)};
