    ...
    class controls {
        ...
        */
        ...
        class menuContainer: cTab_RscControlsGroup {
            ...
            x = QUOTE(ANDROID_pixel2Screen_X(OSD_menu_px_X));
            y = QUOTE(ANDROID_pixel2Screen_Y(OSD_menu_px_Y));
            w = QUOTE(ANDROID_pixel2Screen_W(OSD_menu_px_W));
            h = QUOTE(ANDROID_pixel2Screen_H(OSD_menu_px_H));
            class VScrollbar {};
            class HScrollbar {};
            class Scrollbar {};
            class controls {
                ...
                class btnTextonoff: cTab_RscButton {
                    ...
                    x = QUOTE(ANDROID_pixel2Menu_X(OSD_menuElement_px_X));
                    y = QUOTE(ANDROID_pixel2Menu_Y(OSD_menuElement_px_Y(1)));
                    w = QUOTE(ANDROID_pixel2Screen_W(OSD_menuElement_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(OSD_menuElement_px_H));
                    tooltip = "Toggle Text on/off"; //--- ToDo: Localize;
                    action = QUOTE([QQGVARMAIN(Android_dlg)] call FUNC(caseButtonsIconTextToggle););
                };
                class btnIcnSizeup: btnTextonoff {
                    idc = 10;
                    text = "Icon Size +"; //--- ToDo: Localize;
                    y = QUOTE(ANDROID_pixel2Menu_Y(OSD_menuElement_px_Y(2)));
                ...
                class btnIconSizedwn: btnTextonoff {
                    idc = 11;
                    text = "Icon Size -"; //--- ToDo: Localize;
                    y = QUOTE(ANDROID_pixel2Menu_Y(OSD_menuElement_px_Y(3)));
                    tooltip = "Decrease Icon/Text Size"; //--- ToDo: Localize;
                    action = QUOTE(-1 call FUNC(caseButtonsAdjustTextSize););
                };
                class btnF5: btnTextonoff {
                    idc = 12;
                    y = QUOTE(ANDROID_pixel2Menu_Y(OSD_menuElement_px_Y(7)));
                    text = "Map Tools";
                    tooltip = "Toggle Map Tools (F5)";
                    action = QUOTE([QQGVARMAIN(Android_dlg)] call FUNC(toggleMapTools));
                };
                class btnF6: btnTextonoff {
                    idc = 14;
                    y = QUOTE(ANDROID_pixel2Menu_Y(OSD_menuElement_px_Y(5)));
                    text = "Map Textures";
                    tooltip = "Toggle Map Textures (F6)";
                    action = QUOTE([QQGVARMAIN(Android_dlg)] call FUNC(caseButtonsMapTypeToggle););
                };
        ...
        class MESSAGE: cTab_RscControlsGroup {
            ...
            class controls {
                class msgListbox: cTab_RscListBox {
                    ...
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_read_list_px_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_read_list_px_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_read_list_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_read_list_px_H));
                    onLBSelChanged = QUOTE(_this call FUNC(messagingGetMessage););
                };
                class msgframe: cTab_RscFrame {
                    idc = 16;
                    text = "Read Message"; //--- ToDo: Localize;
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_read_frame_px_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_read_frame_px_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_read_frame_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_read_frame_px_H));
                };
                class msgTxt: cTab_RscEdit {
                    ...
                    sizeEx = QUOTE(ANDROID_pixel2Screen_H(OSD_elementBase_textSize_px));
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_read_text_px_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_read_text_px_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_read_text_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_read_text_px_H));
                    canModify = 0;
                };
                class deletebtn: cTab_RscButton {
                    ...
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_button_delete_px_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_button_delete_px_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_button_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_button_H));
                    action = QUOTE([QQGVARMAIN(Android_dlg)] call FUNC(messagingDeleteSelectedMessage););
                };
                class toCompose: cTab_RscButton {
                    idc = 17;
                    text = "Compose >>"; //--- ToDo: Localize;
                    tooltip = "Compose Messages";
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_mode_button_px_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_mode_button_px_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_button_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_button_H));
                    action = QUOTE(ARR_2([QQGVARMAIN(Android_dlg),[[ARR_2('SETTING_MODE','SETTING_MODE_MESSAGES_COMPOSE')]]]) call FUNC(setSettings));
                };
            };
        };
        // ---------- MESSAGING COMPOSE -----------
        class COMPOSE: cTab_RscControlsGroup {
            ...
            class controls {
                class composeFrame: cTab_RscFrame {
                    ...
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_compose_frame_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_compose_frame_Y));
                ...
                class playerlistbox: cTab_RscListBox {
                    ...
                    style = LB_MULTI;
                    sizeEx = QUOTE(ANDROID_pixel2Screen_H(OSD_elementBase_textSize_px * 0.8));
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_compose_list_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_compose_list_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_compose_list_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_compose_list_H));
                };
                class sendbtn: cTab_RscButton {
                    idc = IDC_CTAB_MSG_BTNSEND;
                    text = "Send"; //--- ToDo: Localize;
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_button_send_px_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_button_send_px_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_button_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_button_H));
                ...
                class edittxtbox: cTab_RscEdit {
                    ...
                    text = ""; //--- ToDo: Localize;
                    sizeEx = QUOTE(ANDROID_pixel2Screen_H(OSD_elementBase_textSize_px));
                    x = QUOTE(ANDROID_pixel2GroupRect_X(ANDROID_messages_compose_text_px_X));
                    y = QUOTE(ANDROID_pixel2GroupRect_Y(ANDROID_messages_compose_text_px_Y));
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_compose_text_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_compose_text_px_H));
                };
                class toRead: cTab_RscButton {
                    ...
                    w = QUOTE(ANDROID_pixel2Screen_W(ANDROID_messages_button_px_W));
                    h = QUOTE(ANDROID_pixel2Screen_H(ANDROID_messages_button_H));
                    action = QUOTE(ARR_2([QQGVARMAIN(Android_dlg),[[ARR_2('SETTING_MODE','SETTING_MODE_MESSAGES')]]]) call FUNC(setSettings));
                };
            };
        };
        ...
        */
        class btnMenu: cTab_android_btnMenu {
            idc = IDC_CTAB_BTNFN;
            action = QUOTE([QQGVARMAIN(Android_dlg)] call FUNC(showMenuToggle););
            tooltip = "Map Options";
        };
        ...
        class btnHome: cTab_android_btnHome {
            idc = IDC_CTAB_BTNF1;
            action = QUOTE([QQGVARMAIN(Android_dlg)] call FUNC(caseButtonsToggleMode););
