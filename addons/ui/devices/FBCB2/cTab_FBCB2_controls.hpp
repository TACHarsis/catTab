...
#define pxToGroup_X(PIXEL) (((PIXEL) - cTab_GUI_FBCB2_SCREEN_CONTENT_X) / BACKGROUND_PIXEL_W * CUSTOM_GRID_WAbs)
#define pxToGroup_Y(PIXEL) (((PIXEL) - cTab_GUI_FBCB2_SCREEN_CONTENT_Y) / BACKGROUND_PIXEL_H * CUSTOM_GRID_HAbs)
...
class cTab_FBCB2_background: cTab_RscPicture {
    ...
    text = QPATHTOEF(data,img\FBCB2.paa);
    x = CUSTOM_GRID_X;
    y = CUSTOM_GRID_Y;
    w = CUSTOM_GRID_WAbs;
    h = CUSTOM_GRID_HAbs;
