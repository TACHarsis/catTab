...
#define pxToGroup_X(PIXEL) (((PIXEL) - cTab_GUI_tablet_SCREEN_CONTENT_X) / BACKGROUND_PIXEL_W * CUSTOM_GRID_WAbs)
#define pxToGroup_Y(PIXEL) (((PIXEL) - cTab_GUI_tablet_SCREEN_CONTENT_Y) / BACKGROUND_PIXEL_H * CUSTOM_GRID_HAbs)
...
class cTab_Tablet_window_back_TL: cTab_RscPicture {
    text = QPATHTOEF(data,img\window_2.jpg);
...
class cTab_Tablet_movingHandle_B: cTab_Tablet_movingHandle_T {
    ...
    h = pxToScreen_H(BACKGROUND_PIXEL_H - (cTab_GUI_tablet_MAP_Y + cTab_GUI_tablet_MAP_H));
};
...
class cTab_Tablet_movingHandle_R: cTab_Tablet_movingHandle_L {
    ...
    w = pxToScreen_W(BACKGROUND_PIXEL_W - (cTab_GUI_tablet_MAP_X + cTab_GUI_tablet_MAP_W));
};
