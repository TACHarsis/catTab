...
class cTab_microDAGR_movingHandle_B: cTab_microDAGR_movingHandle_T {
    ...
    h = pxToScreen_H(BACKGROUND_PIXEL_H - (cTab_GUI_microDAGR_MAP_Y + cTab_GUI_microDAGR_MAP_H));
};
...
class cTab_microDAGR_movingHandle_R: cTab_microDAGR_movingHandle_L {
    ...
    w = pxToScreen_W(BACKGROUND_PIXEL_W - (cTab_GUI_microDAGR_MAP_X + cTab_GUI_microDAGR_MAP_W));
};
